...
const BeautyToolsComponents = () => {
    const products = [

{
    id: 2,
    name: "Jade Roller Gua Sha Set - (Pink Colour)",
    originalPrice: 2000,
    discountedPrice: 1800,
    image: "/images/roller1.png"
},

{
  id: 2,
  name: "Jade Roller Gua Sha Set - (White Colour)",
  originalPrice: 2000,
  discountedPrice: 1700,
  image: "/images/roller2.png"
},
{
    id: 2,
    name: "Jade Roller Gua Sha Set - (Persian Orange)",
    originalPrice: 2000,
    discountedPrice: 1600,
    image: "/images/roller3.png"
},
{
    id: 2,
    name: "Bio Vai Ice Cool Care Mask - 110g",
    originalPrice: 3000,
    discountedPrice: 2700,
    image: "/images/roller4.png"
},
{
    id: 2,
    name: "Jade Roller Gua Sha Set - (Black Colour)",
    originalPrice: 2000,
    discountedPrice: 1850,
    image: "/images/roller5.png"
},
{
    id: 2,
    name: "Jade Roller Gua Sha Set - (Green Colour)",
    originalPrice: 2000,
    discountedPrice: 1570,
    image: "/images/roller6.png"
},
{
    id: 2,
    name: "Jade Roller Gua Sha Set - (Pink Colour)",
...
export default BeautyToolsComponents;
