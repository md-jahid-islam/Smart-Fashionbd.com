...
const ComboComponents = () => {
    const products = [
        {
            id: 1,
            name: "Klair's Midnight Blue Cream 60ml",
            originalPrice: 3100, discountedPrice: 2600,
           
            image: "/images/midnightblue.png"
        },
        {
            id: 2,
            ...
            image: "/images/midnightblue1.png"
        },
        {
          id: 2,
          name: "Koelcia 24K Gold Whitening Essence 35ml",
          ...
          image: "/images/midnightblue2.png"
      },
      {
        id: 2,
        name: "Koelcia 24K Gold Whitening Essence 35ml",
        originalPrice: 3100,
        discountedPrice: 2600,
        image: "/images/midnightblue3.png"
    },
    {
      id: 2,
      name: "Koelcia 24K Gold Whitening Essence 35ml",
    ...
    return (
        <section className="container mx-auto px-4 py-10 pt-44 ">
            <div className='text-center'>
                <h3 className='underline font-bold text-2xl'>Combo Offer</h3>
            </div>
