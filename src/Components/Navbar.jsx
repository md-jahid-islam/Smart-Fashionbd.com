        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="flex items-center gap-4">
              <li>
                <Link className="flex items-center gap-1 text-gray-900 hover:text-blue-600" to="/Card">
                  <FaShoppingCart size={18} />
                  <span className="hidden sm:inline">0.00৳ |</span>
                </Link>
              </li>
              <li>
                <Link className="flex items-center gap-1 text-gray-900 hover:text-blue-600" to="/Login">
                  <FaUser size={18} />
                  <span className="hidden sm:inline">Login</span>
                </Link>
              </li>
              <li className="hidden sm:block">
                <Link className="text-gray-900 hover:text-blue-600" to="/Register"> | Register</Link>
              </li>
            </ul>
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 flex justify-between items-center py-4">
          ...
          <ul className="hidden md:flex md:items-center md:gap-8">
            {["Skincare", "Brand", "MakeUp", "BeautyTools", "Faragrance", "Food", "Sale", "SpecialOffer"].map((item) => (
              <li key={item}>
                <Link to={`/${item}`} className="hover:text-yellow-400 text-lg">{item}</Link>
              </li>
            ))}
          </ul>
        </div>
