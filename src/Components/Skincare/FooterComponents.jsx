...
//         <a href="https://www.facebook.com/jahidul.islam.98621/" target="blank" className="text-gray-400 hover:text-white text-xl"><FaFacebook /></a>
//         <a href="https://x.com/JIslam24072" target="blank" className="text-gray-400 hover:text-white text-xl"><FaTwitter /></a>
//         <a href="https://www.instagram.com/jahidulislamwebbd/" target="blank" className="text-gray-400 hover:text-white text-xl"><FaInstagram /></a>
//         <a href="https://www.linkedin.com/in/jahidul-islam-a5021b325/" target="blank" className="text-gray-400 hover:text-white text-xl"><FaLinkedin /></a>
//       </div>
