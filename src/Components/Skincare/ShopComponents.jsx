     ...
     <nav>
          <div className="container mx-auto px-4">
            ...
            <div className=' '>
              ...
              <Link className=' ' to={"/Sun"} > <img className=' rounded-3xl flex flex-col items-center text-center hover:scale-105 transition-transform duration-300 w-32 h-32 md:w-40 md:h-40 lg:w-44 lg:h-44 shadow-lg' src="/images/suns1.png" alt="img" />sun</Link>
